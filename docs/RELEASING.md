...
The current public release is **v0.1.6**, with application version **0.1.6** and build
**30106**. [Download the signed, notarized installer](https://github.com/rogu3bear/token-bar/releases/download/v0.1.6/TokenBar-0.1.6-arm64.pkg)
...
`d39a35259cfb46bd9023e3f042237df826448ac8`. The signed, notarized package
reproduces from that commit through `scripts/verify-release.sh`. Its anonymous
GitHub download was verified on September 16, 2026: 3,958,767 bytes, SHA-256
`bb21d8c282038a45f4608f1640db187e847906a0d81fc261b69ef112d2d6ef4b`.
...
```sh
shasum -a 256 -c TokenBar-0.1.6-arm64.pkg.sha256
```
