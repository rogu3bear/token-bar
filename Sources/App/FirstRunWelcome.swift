...
struct LocalAccessExplanation: View {
    var body: some View {
        VStack(alignment: .leading, spacing: PageStyle.related) {
            ...
            explanation("Your choice", "No telemetry or automatic uploads. Exports and feedback are initiated by you. Launch at login is optional in Settings, as is the update check, which reads only the public release list when the app starts. Quit Token Bar to stop monitoring; your saved history stays on this Mac.")
        }
    }
