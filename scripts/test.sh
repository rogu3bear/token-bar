...
build_group appearance Tests/Appearance/main.swift "-swift-version 5 -lsqlite3" $CORE InteractionMotion.swift ProviderColumnsLayout.swift NowOccupancyStack.swift DashboardNavigation.swift FirstRunWelcome.swift PreviewFixture.swift UsageTimelineChart.swift CompactToolRate.swift ToolQuotaSummary.swift ClaudeConnectionControl.swift
