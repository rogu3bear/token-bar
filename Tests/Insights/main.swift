...
progressState.begin()
assert(progressState.remainingFiles == nil && progressState.checkingCaption.hasPrefix("Finding"), "a missing total is finding work, not 0 remaining")
...
assert(progressState.remainingFiles == 2)
assert(progressState.checkingCaption == "Checking prompt history · 1 of 3 files · 2 remaining")
