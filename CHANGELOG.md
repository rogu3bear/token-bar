...
- History, Cost, and the dashboard banner share one in-flight report face. A filter change no longer says the selected report is updating while the banner says your report is waiting.
