...
- Codex activity, Claude turns, and provider day bounds share one ISO-8601 parse. A fractional stamp one reader admits is no longer dropped as unavailable by another.
