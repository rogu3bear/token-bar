...
- Remaining percent is one whole-percent face on Now, Accounts, the menu bar, popover and Quota Guard. Guard detail no longer shows a private tenth. A missing speed is an em dash, not `— tok/h`.
