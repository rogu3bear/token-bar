...
- Give the event index, request details, and live observations one owner-only mode after sqlite open. Those files no longer inherit whatever umask sqlite left.
