...
- Give Claude Code’s status-line remaining one leftover percent. jq and JXA no longer disagree, and a missing used figure stays off the line instead of becoming NaN.
