...
- Cost, Insights, and prompt-sample results share one read-age caption: relative age plus the absolute clock. Insights no longer omits how long ago the last successful usage read was.
