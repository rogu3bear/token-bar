...
- Give the app and the feedback form one version-query length. A convenience value longer than that is truncated in the URL and rejected on the page, not accepted as two different limits.
