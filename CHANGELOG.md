...
- Give Grok’s cache-beside totals the same TokenConvention fold as Claude and OpenCode. Grok’s reported total still chooses the dialect; missing cache-write stays unavailable.
