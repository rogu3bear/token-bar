...
- Give leftover Claude harness fixtures ClaudeCodeUsage’s harness. Growing-counter identity and foreign cost attribution keep the same tool string as admission.
