...
- Omitted models share one “Unknown model” label, and coverage groups a missing tool under the same Unattributed face as dimension reports. A spelling variant is not a real model, and a missing tool is not a guessed harness.
