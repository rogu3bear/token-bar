...
- Give Codex Quota Guard the same two-minute remaining horizon Runway uses. Guard still caps action freshness; Codex remaining cannot age on a different clock.
