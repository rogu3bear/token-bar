...
- Give the download button one GitHub Release prefix. The page will not rewrite the link unless `release.json` uses the same origin the published installer already has.
