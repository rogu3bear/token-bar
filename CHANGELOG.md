...
- Connect Claude Code edits `settings.json` in the same home usage reads. A `CLAUDE_HOME` override no longer leaves Connect writing a different tree than transcripts.
