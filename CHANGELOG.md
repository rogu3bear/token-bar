...
- Publish coverage audits, sign-in observations, and cost-recovery backups through one 0600 replace so they never sit world-readable between write and chmod.
