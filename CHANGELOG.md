...
- Give Claude remaining staleness tests ClaudeQuotaSource’s display horizon. Two minutes stays Codex; a cache older than one remaining horizon stays unavailable.
