...
- Give Codex remaining staleness tests Runway’s two-minute horizon. Claude remaining display stays 30 minutes; an hour-old Codex remaining is still stale, but the bound is remaining freshness, not sample retention.
