...
- Give menu-bar remaining tests ClaudeQuotaSource’s remaining identity. Zero remaining and Fable remaining fixtures use the same bucket and name the live Claude remaining path already owns.
