...
- Cost account-total and allowance-window sheets share one calculated-at caption. A refresh in flight still names the retained clock as a previous result, not a new calculation.
