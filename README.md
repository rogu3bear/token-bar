...
*Native previews of Token Bar 0.1.13 with synthetic sample data.*
...
**v0.1.13 · Apple silicon · macOS 14+ · Swift/SwiftUI · MIT**
...
[Download Token Bar 0.1.13 for Mac (.pkg)](https://github.com/rogu3bear/token-bar/releases/download/v0.1.13/TokenBar-0.1.13-arm64.pkg)
...
[Release notes and checksum](https://github.com/rogu3bear/token-bar/releases/tag/v0.1.13)

GitHub Releases hosts the macOS installer. The current download is the
notarized v0.1.13 package above. [Distribution and verification details](docs/RELEASING.md).
